...
namespace Project1_SGBD
{
    ...
    {
        SqlConnection cs = new SqlConnection("Data Source = DESKTOP-QA0LA4T\\SQLEXPRESS;" +
            " Initial Catalog = Cofetarie8; Integrated Security = True");
        ...
        private void dataGridViewParent_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            da.SelectCommand = new SqlCommand("SELECT * from Bauturi " +
                    "where Bauturi.Id_Meniu = " + Id_Meniu + "; ", cs);
            dsC.Clear();
            da.Fill(dsC);
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            da.InsertCommand = new
                SqlCommand("INSERT INTO Bauturi(Id_Meniu, Cantitate, Denumire, Pret, Descriere)" +
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            "from Bauturi where Id_Bautura = @id;", cs);
